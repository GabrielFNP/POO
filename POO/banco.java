                    ...
                    while (i.hasNext()) {
                        ...
                        if (c.numero == nconta) {
                            ...
                            if (deposito_efetuado == true) {
                                ...
                                System.out.println("NÚMERO DA CONTA: "+ nconta+" com sucesso!"+"\n");
                                System.out.println("NOME: " + c.getTitular()+"\n");
                                System.out.println("Saldo Transferido: R$ " + valor);
                    ...
                    while (i.hasNext()) {
                        ...
                        if (c.numero == nconta) {
                            ...
                            if (situacao2 == true) {
                                ...
                                System.out.println(
                                        "Impossível completar ação pois ou você deve ou ainda tem dinheiro na conta.");
                            }
                            break;
